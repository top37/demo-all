...
public class QiniuCloudService {
    ...
    private static final String ACCESS_KEY = "P81IXIEHICzNrsNpJZWkf_kzd1EGA2502DlodwrS";
    private static final String SECRET_KEY = "nObhsdJp-u3ZDt-f8vCPx2fC5M3TK_ZpB7QgZsH6";
    /**
     * 仓库
     */
